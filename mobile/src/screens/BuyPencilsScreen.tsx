...
interface BuyPencilsScreenProps {
  onBack: () => void;
}

interface PencilPackage {
  id: string;
  amount: number;
  price: number;
  bonus?: number;
...
const BuyPencilsScreen: React.FC<BuyPencilsScreenProps> = ({onBack}) => {
  ...
  const packages: PencilPackage[] = [
    {id: '1', amount: 100, price: 1100},
    {id: '2', amount: 500, price: 5500, bonus: 50},
    {id: '3', amount: 1000, price: 11000, bonus: 150, popular: true},
    {id: '4', amount: 3000, price: 33000, bonus: 500},
    {id: '5', amount: 5000, price: 55000, bonus: 1000},
    {id: '6', amount: 10000, price: 110000, bonus: 2500},
  ];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>{t('payment.buyPencils')}</Text>
        <View style={{width: 40}} />
      </View>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
        ...
        <View style={styles.packagesSection}>
          <Text style={styles.sectionTitle}>연필 패키지</Text>
          {packages.map((pkg) => (
        ...
        <View style={styles.noticeSection}>
          ...
          <Text style={styles.noticeText}>• 구매한 연필은 즉시 지급됩니다.</Text>
...
const getStyles = (isDark: boolean) =>
  StyleSheet.create({
    ...
    balanceCard: {
      ...
      alignItems: 'center',
      borderWidth: 2,
      borderColor: isDark ? '#FFD700' : '#FFC233',
    },
    balanceLabel: {
      fontSize: 14,
...
export default BuyPencilsScreen;
