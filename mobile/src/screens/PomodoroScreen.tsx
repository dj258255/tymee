...
const PomodoroScreen: React.FC = () => {
  ...
  useEffect(() => {
    setTempWorkDuration(settings.workDuration.toString());
    setTempShortBreak(settings.shortBreakDuration.toString());
    setTempLongBreak(settings.longBreakDuration.toString());
  }, [settings]);

  const handleSaveTimerSettings = () => {
    const work = parseInt(tempWorkDuration) || 25;
    const shortBreak = parseInt(tempShortBreak) || 5;
    const longBreak = parseInt(tempLongBreak) || 15;
            ...
            <View style={styles.settingsInputContainer}>
              ...
              <View style={styles.settingItem}>
                ...
                <TextInput
                  ...
                  onChangeText={setTempShortBreak}
                  keyboardType="number-pad"
                  maxLength={3}
                  placeholder="5"
                  placeholderTextColor={isDark ? '#666666' : '#999999'}
